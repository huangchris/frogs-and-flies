...
Frog.prototype.eats = function(fly) {
  ...
  if(this.dir === -1){
    if( fly.xPos > (this.xPos - this.tongueWidth) &&
      fly.xPos < this.xPos && fly.yPos > (this.yPos + 0.025) &&
      fly.yPos < (this.yPos + 0.055)
    ){
      console.log("true")
      return true;
    }
    ...
    if ( fly.xPos > (this.xPos + 0.1) &&
      fly.xPos < (this.xPos + + 0.1 + this.tongueWidth) &&
      fly.yPos > (this.yPos + 0.025) && fly.yPos < (this.yPos + 0.055)
    ){
      console.log("true")
      return true;
    }
